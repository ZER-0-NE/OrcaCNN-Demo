...
def eval_network(weights_file="weights.hdf5", classpath="Preproc/Test/", batch_size=10):
    np.random.seed(1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', default=5, type=int, help="Number of clips to send to GPU at once")

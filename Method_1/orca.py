...
def preprocess_dataset(inpath="data/training", outpath="Preproc/", train_percentage=0.8, resample=None, already_split=False,
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i','--inpath', help="input directory for audio samples (default='Samples')", type=str, default='data/training')

...
def train_network(weights_file="weights.hdf5", classpath="Preproc/Train/", epochs=50, batch_size=8, val_split=0.30,tile=False):
    np.random.seed(1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', default=2, type=int, help="Number of clips to send to GPU at once")
    parser.add_argument('--val', default=0.3, type=float, help="Fraction of train to split off for validation")

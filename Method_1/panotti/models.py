...
def MyCNN_Keras2(X_shape, nb_classes, nb_layers=6):
    # Inputs:
    ...
    cl_dropout = 0.6   # conv. layer dropout
    dl_dropout = 0.5    # dense layer dropout
...
def attach_new_weights(model, new_nb_classes, n_pop = 2, n_p_dense = None, last_dropout = 0.5):
